    ...
    <section class="items-grid section custom-padding">
        <div class="container">
            ...
            <div class="single-head">
            	<!-- Bootstrap에서 사용하는 row클래스는 해당윈도우 너비를 전체 다 씀 -->
                <div class="row">
                	<%
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-grid wow fadeInUp" data-wow-delay=".4s">
                            <div class="image">
                                <a href="" class="thumbnail"><img src="${pageContext.request.contextPath}/resources/assets/images/items-grid/img5.jpg" alt="#"></a>
                                <div class="author">
